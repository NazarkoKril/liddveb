...
document.addEventListener('DOMContentLoaded', () => {
    const openDelay = 400; // налаштуйте час відкриття (в мс)
    ...
    resetContent(cards[activeIndex]);
    setTimeout(() => {
      showContent(cards[activeIndex]);
      triggerAnimationsWhenVisible(cards[activeIndex]);
    }, openDelay);
